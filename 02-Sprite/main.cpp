...
#define TEXTURE_PATH_ENEMIES TEXTURES_DIR "\\enemies-removebg.png"
...
CBrick *brick;
CMonster* monster;
#define MONSTER_START_X 10.0f
#define MONSTER_START_Y 150.0f
#define MONSTER_START_VX 0.1f
...
void LoadResources()
{
	...
	LPTEXTURE texMons = textures->Get(ID_TEX_ENEMY);
	sprites->Add(30001, 90, 126, 110, 158, texMons);
	sprites->Add(30002, 116, 126, 130, 158, texMons);
	sprites->Add(30003, 136, 126, 150, 158, texMons);
	sprites->Add(30004, 156, 126, 170, 158, texMons);
	...
	monster = new CMonster(MONSTER_START_X, MONSTER_START_Y, MONSTER_START_VX);
}
